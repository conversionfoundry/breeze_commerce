  ...
  module Commerce
    class CustomerLoginForm < Breeze::Content::Item
      ...
      def to_erb(view)
        ...
        content = view.controller.render_to_string partial: "partials/commerce/customer_login_form", layout: false, locals: {allow_returning_customer_login: store.allow_returning_customer_login, title: title}
      end
    end
  end
end
module Breeze
  module Commerce
    module Shipping
      ...
      class ThresholdShippingMethod < Breeze::Commerce::Shipping::ShippingMethod
        ...
        def self.human_readable_name
          "Flat rate shipping, with threshold"
        end

        def self.explanation
          "Two price tiers, depending on the order total."
        end
